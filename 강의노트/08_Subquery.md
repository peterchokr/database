...
서울에 위치한 부서들의 전체 평균 급여보다 더 많이 받는 직원의 이름을 조회
...
**5번 과제**: Part 3의 실습 8-1부터 8-25까지 제공된 모든 쿼리를 직접 실행하고, 각 쿼리의 결과를 스크린샷으로 첨부하세요. 추가로 5개 이상의 창의적인 서브쿼리를 작성하여 그 결과를 제시하고, 각 쿼리의 목적과 실무 활용 방법을 설명하세요.
