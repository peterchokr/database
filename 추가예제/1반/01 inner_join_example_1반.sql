...
-- 문제 1: 2024년 6월에 주문한 회원의 이름과 주문 번호를 조회하세요.
-- (힌트: orders와 users 조인)

-- 문제 2: '전자제품' 카테고리에 속한 상품들의 이름과 가격을 조회하세요.
-- (힌트: products와 categories 조인)

-- 문제 3: 각 회원이 구매한 상품명과 수량을 조회하세요.
-- (힌트: users, orders, order_items, products 조인)

-- 문제 4: 카테고리별 총 판매 수량과 총 매출을 조회하세요.
-- (힌트: categories, products, order_items 조인 + GROUP BY)

-- 문제 5: '김철수' 회원이 구매한 상품의 카테고리명과 상품명을 조회하세요.
-- (힌트: 5개 테이블 모두 조인 + WHERE 조건)