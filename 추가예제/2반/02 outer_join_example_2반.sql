...
-- LEFT JOIN 퀴즈 기초
-- ─────────────────────────────────────────────────────────────────
-- [LEFT 기초 퀴즈 1] 주문을 하지 않은 고객의 이름과 이메일을 모두 찾으세요.


-- [LEFT 기초 퀴즈 2] 각 고객별 마지막 주문 날짜를 조회하세요. 주문이 없는 고객은 NULL로 표시됩니다.


-- [LEFT 중급 퀴즈 3] 각 상품별 판매 수량과 리뷰 개수를 조회하세요. 판매되지 않은 상품도 포함하고, 판매량 기준으로 정렬합니다.


-- [LEFT 중급 퀴즈 4] 모든 고객의 구매 이력을 타임라인으로 표시하세요. 고객명, 주문날짜, 주문금액을 표시하고, 최신 주문부터 정렬합니다.
...
-- [RIGHT 기초 퀴즈 1] 모든 주문 항목의 상품명을 함께 조회하세요. 주문항목 ID, 수량, 상품명을 표시합니다.


-- [RIGHT 기초 퀴즈 2] 모든 주문 항목별로 상품 가격과 수량을 조회하여 소계(가격 * 수량)를 계산하세요.


-- [RIGHT 중급 퀴즈 3] 모든 리뷰와 함께 리뷰를 작성한 고객의 이름과 이메일을 조회하세요. 최신 리뷰부터 정렬합니다.


-- [RIGHT 중급 퀴즈 4] 모든 주문 항목에 대해 상품 카테고리, 상품명, 가격, 수량, 소계를 조회하세요.
